...
public class FreelanceWorker implements Worker {
    ...
    @Override
    public void onStart() {
        freelanceChannel = (GuildMessageChannel) ChannelCache.fetch(DevArea.data.freelance_channel.asString()).entity;
    ...
    public static boolean bumpFreeLance(String id) {
        ...
        startAway(() -> freeLance.getMessage().getMessage().delete());
    ...
    public static Message sendFreelanceMessage(final DBFreelance freeLance) {
        return ((GuildMessageChannel) ChannelCache.watch(DevArea.data.freelance_channel.asString()).entity)
     ...
     */
    public static void deleteFreelanceOf(final DBFreelance freelance) {
        startAway(() -> freelance.getMessage().getMessage().delete().subscribe());
        DBManager.deleteFreelanceOf(freelance.get_id());
    }
