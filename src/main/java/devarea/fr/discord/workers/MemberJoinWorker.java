...
public class MemberJoinWorker implements Worker {
    ...
    public OneEvent<?> setupEvent() {
        return (OneEvent<MemberJoinEventFiller>) event -> {
            ...
            startAway(() -> ((GuildMessageChannel) ChannelCache.watch(DevArea.data.welcome_channel.asString())
            ...
            ((GuildMessageChannel) ChannelCache.watch(DevArea.data.general_channel.asString()))
