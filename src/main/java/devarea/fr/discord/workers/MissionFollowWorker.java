...
public class MissionFollowWorker implements Worker {
    @Override
    public void onStart() {
        Logger.logMessage("MissionFollowWorker Created !");
    }
    ...
    private static void followThisMission(DBMission mission, Snowflake member_react_id) {
        ...
        GuildMessageChannel channel = DevArea.devarea.createTextChannel(TextChannelCreateSpec.builder()
                .parentId(DevArea.data.mission_follow_category)
    ...
    private static Set<PermissionOverwrite> getPermissionsOverrideCreatePrivateChannel(DBMission mission,
        ...
        set.add(PermissionOverwrite.forRole(DevArea.data.rulesAccepted_role, PermissionSet.of(),
                PermissionSet.of(Permission.VIEW_CHANNEL)));
        set.add(PermissionOverwrite.forRole(DevArea.devarea.getEveryoneRole().block().getId(), PermissionSet.of(),
                PermissionSet.of(Permission.VIEW_CHANNEL)));
